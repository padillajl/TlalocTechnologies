...
**     Date/Time   : 2012-12-23, 15:30, # CodeGen: 162
**     Abstract    :
...
**              Library Lowest Interrupt Priority          : 3
...
**          Command Interpreter                            : Settings for the command interpreter built in the RTOS sources
...
**     FreeRTOS (c) Copyright 2003-2012 Richard Barry, http: www.FreeRTOS.org
...
*/
__attribute__((naked))
void RTOSTICKLDD1_OnCounterRestart(LDD_TUserData *UserDataPtr __attribute__((unused)))
{
  vOnCounterRestart();
}
