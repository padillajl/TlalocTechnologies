...
#if configUSE_ALTERNATIVE_API == 1 /* << EST */
...
static void prvCopyDataToQueue( xQUEUE *pxQueue, const void *pvItemToQueue, portBASE_TYPE xPosition )
{
        ...
        {
                (void)memcpy( ( void * ) pxQueue->pcWriteTo, pvItemToQueue, ( unsigned ) pxQueue->uxItemSize );
        ...
        {
                (void)memcpy( ( void * ) pxQueue->pcReadFrom, pvItemToQueue, ( unsigned ) pxQueue->uxItemSize );
...
static void prvCopyDataFromQueue( xQUEUE * const pxQueue, const void *pvBuffer )
{
        if( pxQueue->uxQueueType != queueQUEUE_IS_MUTEX )
        {
                ...
                (void)memcpy( ( void * ) pvBuffer, ( void * ) pxQueue->pcReadFrom, ( unsigned ) pxQueue->uxItemSize );
        }
}
/*-----------------------------------------------------------*/
